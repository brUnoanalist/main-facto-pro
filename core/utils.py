...
def limpiar_rut(rut):
    ...
    Args:
        rut: String con el RUT (puede tener formato o no)

    Returns:
        String con solo números y dígito verificador

    Ejemplos:
        >>> limpiar_rut('12.345.678-9')
        '123456789'
        >>> limpiar_rut('12345678-9')
        '123456789'
    """
    if not rut:
        return ''
...
def calcular_digito_verificador(rut_sin_dv):
    ...
    Args:
        rut_sin_dv: String o int con el RUT sin dígito verificador
...
def formatear_rut(rut):
    ...
    Returns:
        String con el RUT formateado o el input original si no es válido

    Ejemplos:
        >>> formatear_rut('123456785')
        '12.345.678-5'
        >>> formatear_rut('12345678-5')
        '12.345.678-5'
